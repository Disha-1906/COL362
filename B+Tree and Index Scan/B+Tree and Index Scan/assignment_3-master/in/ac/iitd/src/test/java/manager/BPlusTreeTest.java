...
//            System.out.println("Expected result size: " + expected_result.size() + "\n");
...
//            System.out.println("\n");
            ...
            for(int i = 0; i < result.size(); i++){
//                System.out.println("Expected value: " + expected_result.get(i) + "\n");
//                System.out.println("Obtained value: " + result.get(i) + "\n");
